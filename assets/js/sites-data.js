window.SAKURA_DATA = Object.freeze({
  ...
  sites: [
    ...
    { id: "shadowrocket-apple-id", name: "小火箭 Apple ID 共享", url: "https://id.ruyie.de/", description: "提供已购 Shadowrocket 的共享 Apple ID，仅供 App Store 登录使用。", category: "ios", keywords: ["小火箭", "Shadowrocket", "Apple ID", "苹果账号", "美区ID", "ruyie"], addedAt: "2026-08-11" },
